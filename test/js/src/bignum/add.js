...
var check = function(ctor, r, e){
	var name = util.format("bignum.add (%s, %d, %s)", ctor.name, r, e === algo.badd_t ? 'big endian' : 'little endian');
	console.log(name);
	...
	var lsb = function(a){ return e === algo.badd_t ? a.length - 1 : 0; };
...
var ENDIANESS = [algo.badd_t, algo.ladd_t];
